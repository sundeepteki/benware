function grid = grid_st_statistical_learning_A()

%{

Function: Runs basic Lu and Vicario experiment 1 in a single session
Usage:    grid = grid_st_statistical_learning_A()
...
- Training:     48 repeats of vowel sequence (containing 6 x 4-element words) in one block. Repeat 4 times
  
                Use two different exposure streams across animals

- Test stimuli: Words / Non-words/Part-words x 48 repeats per category(8 repeats per individual w/pw/nw)

------------
Sundeep Teki
v1: 26-Jun-2016 14:16:17
