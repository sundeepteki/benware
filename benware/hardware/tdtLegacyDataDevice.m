classdef tdtLegacyDataDevice < tdtDevice
  properties
    nChannels = nan;
    rcxSetup = [];
  end
  ...
  methods
    ...
    function obj = tdtLegacyDataDevice(deviceInfo, requestedSampleRateHz, channelMap, ~)
      % initialise the class itself
      
      % default value
      rco_leafname = [deviceInfo.name '-nogain-legacy.rcx'];
