classdef tdtLoopbackDevice < tdtDevice
  properties
    nChannels = nan;
    rcxSetup = [];
  end
  ...
  methods
    ...
    function obj = tdtLoopbackDevice(deviceInfo, requestedSampleRateHz, channelMap, ~)
      % initialise the class itself
      obj.rcxSetup.rcxFilename = ['benware/tdt/' deviceInfo.name '-loopback.rcx'];
      obj.rcxSetup.versionTagName = [deviceInfo.name 'LoopbackVer'];
