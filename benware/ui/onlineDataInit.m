...
%onlineData.sweepHistoryLength = 40;
...
binsize = possible_binsizes( ...
        find(nSamplesExpected/onlineData.sampleRate/50>possible_binsizes, 1, 'last'));
if isempty(binsize)
    binsize = min(possible_binsizes);
end

onlineData.psth.binsize = binsize;
edges = 0:onlineData.psth.binsize:nSamplesExpected/onlineData.sampleRate;
...
nLFPsamplesExpected = nSamplesExpected/sampleRate * onlineData.lfp.sampleRate;
