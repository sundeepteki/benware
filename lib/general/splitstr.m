function parts = splitstr(splitstr, str)
%split_str Split a string based upon an array of character
%delimiters
%
%   split_str(splitstr, str) splits the string STR at every
%   occurrence
%   of an array of characters SPLITSTR and returns the result as a
%   cell
%   array of strings.
%
...
for x=1:length(splitstr)
  k = [k strfind(str, splitstr(x))];     %combines all the
					 %found indexes
end
